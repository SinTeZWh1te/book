...
==== Java
В настоящий момент де-факто стандарт в бизнес приложениях, то есть таких, где не особенно критична скорость работы и не требуется обработки больших данных. Система пакетов, строгая типизация, консервативное развитие без катаклизмов долгие годы.
Когда-то он задумывался быть везде: апплеты на Web страницах, десктоп приложения, даже игры и специализированное железо, но остался в итоге в
основном на Backend е заменителем Кабола.

// TODO: Память на мелких объектов.

// TODO: Java based.

Несколько ссылок на неплохие книжки по Java для начала изучения:
[square]
